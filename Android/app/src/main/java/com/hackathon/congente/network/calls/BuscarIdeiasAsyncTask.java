...
public class BuscarIdeiasAsyncTask extends NetworkAccess {
    private String URL_CADASTRAR_IDEIA = "http://congente.jedevmobile.com/api/BuscarIdeias.php";
    private Ideia _ideia = null;
    private IdeiaCallback _callback;

    public BuscarIdeiasAsyncTask(Ideia ideia, IdeiaCallback callback){
        _ideia = ideia;
        _callback = callback;
    }
